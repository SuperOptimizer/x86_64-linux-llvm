...
-DCMAKE_CXX_COMPILER_LAUNCHER=ccache \
-DCMAKE_CXX_FLAGS=" -nostdinc -nostdinc++ --sysroot ${SYSROOT_DIR} -static -w -Os -g0 -unwind=libunwind --rtlib=compiler-rt -stdlib=libc++   " \
-DCMAKE_CXX_STANDARD=20 \
-DCMAKE_C_COMPILER=clang-21 \
-DCMAKE_C_COMPILER_WORKS=1 \
-DCMAKE_C_COMPILER_LAUNCHER=ccache \
-DCMAKE_C_FLAGS=" -nostdinc -nostdinc++  --sysroot ${SYSROOT_DIR} -static -w -Os -g0 -unwind=libunwind --rtlib=compiler-rt " \
-DCMAKE_EXE_LINKER_FLAGS=" -nostdinc -nostdinc++  --sysroot ${SYSROOT_DIR} -static -unwind=libunwind --rtlib=compiler-rt -stdlib=libc++ " \
...
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_FLAGS=" -nostdinc -nostdinc++  --sysroot ${SYSROOT_DIR}  -w -Os -g0    " \
...
-DRUNTIMES_x86_64-linux-gnu_CMAKE_C_FLAGS=" -nostdinc -nostdinc++  --sysroot ${SYSROOT_DIR} -w -Os -g0   " \
