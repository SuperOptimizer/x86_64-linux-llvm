...
-DCMAKE_CXX_COMPILER_LAUNCHER=ccache \
-DCMAKE_CXX_FLAGS=" -nostdinc -nostdinc++ -isystem ${SYSROOT_DIR}/include/c++/v1/  -isystem ${SYSROOT_DIR}/include -isystem ${SYSROOT_DIR}/usr/include -isystem ${SYSROOT_DIR}/lib/clang/21/include/  --sysroot ${SYSROOT_DIR} -static -w -Os -g0 -unwind=libunwind --rtlib=compiler-rt -stdlib=libc++   " \
-DCMAKE_CXX_STANDARD=20 \
-DCMAKE_C_COMPILER=clang-21 \
