...
-DCMAKE_CXX_FLAGS=" -w -Os -g0  --sysroot ${SYSROOT_DIR} -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt   " \
-DCMAKE_CXX_STANDARD=20 \
-DCMAKE_C_COMPILER=clang-21 \
-DCMAKE_C_COMPILER_LAUNCHER=ccache \
-DCMAKE_C_COMPILER_WORKS=1 \
-DCMAKE_C_FLAGS=" -w -Os -g0  --sysroot ${SYSROOT_DIR}  -unwind=libunwind --rtlib=compiler-rt  " \
-DCMAKE_EXE_LINKER_FLAGS="  --sysroot ${SYSROOT_DIR} -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt   " \
...
-DRUNTIMES_x86_64-linux-gnu_CMAKE_BUILD_TYPE=MinSizeRel \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_COMPILER="clang++-21" \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_COMPILER_LAUNCHER=ccache \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_COMPILER_WORKS=1 \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_FLAGS=" --sysroot ${SYSROOT_DIR}  -w -Os -g0 -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt  " \
...
-DRUNTIMES_x86_64-linux-gnu_CMAKE_C_COMPILER_WORKS=1 \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_C_FLAGS=" --sysroot ${SYSROOT_DIR}    -w -Os -g0  -unwind=libunwind --rtlib=compiler-rt  " \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_EXE_LINKER_FLAGS=" --sysroot ${SYSROOT_DIR}  -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt " \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_INSTALL_PREFIX="${SYSROOT_DIR}" \
...
-DRUNTIMES_x86_64-linux-gnu_LIBCXX_ENABLE_TIME_ZONE_DATABASE=OFF \
...
-DRUNTIMES_x86_64-linux-gnu_LIBCXX_HAS_PTHREAD_API=OFF \
...
-DCMAKE_CXX_COMPILER_LAUNCHER=ccache \
-DCMAKE_CXX_COMPILER_WORKS=1 \
-DCMAKE_CXX_FLAGS=" -w -Os -g0  --sysroot ${SYSROOT_DIR} -isystem ${SYSROOT_DIR}/include/c++/v1  -isystem ${SYSROOT_DIR}/include -isystem ${SYSROOT_DIR}/usr/include -isystem ${SYSROOT_DIR}/usr/lib/gcc/x86_64-pc-linux-gnu/15.0.1/include/   -nostdinc -nostdinc++ -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt   " \
-DCMAKE_CXX_STANDARD=20 \
-DCMAKE_C_COMPILER=clang-21 \
-DCMAKE_C_COMPILER_LAUNCHER=ccache \
-DCMAKE_C_COMPILER_WORKS=1 \
-DCMAKE_C_FLAGS=" -w -Os -g0  --sysroot ${SYSROOT_DIR} -nostdinc -nostdinc++ -isystem ${SYSROOT_DIR}/include -isystem ${SYSROOT_DIR}/usr/include -isystem ${SYSROOT_DIR}/usr/lib/gcc/x86_64-pc-linux-gnu/15.0.1/include/  -unwind=libunwind --rtlib=compiler-rt  " \
-DCMAKE_EXE_LINKER_FLAGS="  --sysroot ${SYSROOT_DIR} -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt   " \
-DCMAKE_INSTALL_PREFIX="${SYSROOT_DIR}" \
-DCMAKE_SYSROOT="${SYSROOT_DIR}" \
-DCMAKE_TARGET_TRIPLE="x86_64-linux-gnu" \
...
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_COMPILER_LAUNCHER=ccache \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_COMPILER_WORKS=1 \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_FLAGS=" --sysroot ${SYSROOT_DIR}  -isystem ${SYSROOT_DIR}/include/c++/v1 -isystem ${SYSROOT_DIR}/usr/lib/gcc/x86_64-pc-linux-gnu/15.0.1/include/  -nostdinc -nostdinc++ -isystem ${SYSROOT_DIR}/include -isystem ${SYSROOT_DIR}/usr/include  -w -Os -g0 -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt  " \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_CXX_STANDARD=20 \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_C_COMPILER="clang-21" \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_C_COMPILER_LAUNCHER=ccache \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_C_COMPILER_WORKS=1 \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_C_FLAGS=" --sysroot ${SYSROOT_DIR}  -nostdinc -nostdinc++ -isystem ${SYSROOT_DIR}/include  -isystem ${SYSROOT_DIR}/usr/lib/gcc/x86_64-pc-linux-gnu/15.0.1/include/ -isystem ${SYSROOT_DIR}/usr/include  -w -Os -g0  -unwind=libunwind --rtlib=compiler-rt  " \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_EXE_LINKER_FLAGS=" --sysroot ${SYSROOT_DIR}  -stdlib=libc++ -unwind=libunwind --rtlib=compiler-rt " \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_INSTALL_PREFIX="${SYSROOT_DIR}" \
-DRUNTIMES_x86_64-linux-gnu_CMAKE_SYSROOT="${SYSROOT_DIR}" \
-DRUNTIMES_x86_64-linux-gnu_COMPILER_RT_BUILD_BUILTINS=ON \
